...
-- language-specific
vim.keymap.set("n", "<F5>", ":w<Enter>:exec '!wezterm start -- pythonp ' shellescape(@%, 1) '&'<Enter>", {remap=true, desc="Run Python"})
vim.keymap.set("i", "<F5>", "<Esc>:w<Enter>:exec '!wezterm start -- pythonp ' shellescape(@%, 1) '&'<Enter>a", {remap=true, desc="Run Python"})
